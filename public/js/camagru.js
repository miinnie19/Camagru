    ...
    */
    ...
    if (login)
    {
      login.addEventListener('submit', function (e) {
        ...
        /*
        ** validate_xxx functions check if input is valid
        */
          ...
          req.onload = function (event) {
              ...
              else
              {
                ...
                */
                ...
                login_btn.innerHTML = 'camagru error!';
                login_btn.style.backgroundColor = color_red;
              }
          };
          ...
          */
          ...
          if (index != -1) {
            ...
            req.onload = function (event) {
                ...
                {
                  reset_btn.innerHTML = 'camagru error!';
                  reset_btn.style.backgroundColor = color_red;
                }
            };
            window.setTimeout(function () {
            ...
            if (comment) {
              if (comment.data.value != '') {
                ...
                req.onload = function (event) {
                  ...
                  {
                    button.style.backgroundColor = color_red;
                    button.innerHTML = 'Camagru error!';
                  }
                };
                req.send(data);
              }
      ...
      if (req.status == 200)
      {
        ...
        */
        ...
        if (result['like_status'] !== undefined) {
          if (result['like_status'] === 200) {
            ...
            document.getElementById(id + ' like-count').style.color = 'white';
          }
        }
        ...
        */
        ...
        if (result['like_error'] !== undefined) {
          ...
          document.getElementById('header-modal').innerHTML = 'slight problemo';
...
function validate_username(username)
{
  ...
  {
    document.getElementById('b-username').style.color = "teal";
    document.getElementById('username').style.border = "2px solid teal";
...
function validate_email(email)
{
  ...
  if (reg.test(email) == false) {
    ...
    document.getElementById('b-email').style.color = "teal";
...
function validate_password(password)
{
  if (password.length < 8)
  {
    ...
    document.getElementById('b-password').style.color = "teal";
        ...
        if (form) {
          ...
          */
          ...
          if (textarea) {
            ...
            textarea.placeholder = 'Great pic!';
            textarea.rows = '3';

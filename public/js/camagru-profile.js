/*
** Ths js file is for the profile page
*/
...
window.onload =  () => {
			...
			req.onload = (e) => {
				if (req.status == 200) {
					...
					if (resp.status == 200) {
						...
						del_btn.innerHTML = 'Image deleted';
						del_btn.style.background = 'teal';
						window.setTimeout(function () {
						...
						del_btn.innerHTML = 'Error occured';
					}
				}
			};
			req.send(data);
	...
	** Also update the index of the asset selection to be passed as post
	...
	*/
	...
	/*
	** Send request to server, to check how many likes an image has
	*/
...
/*
** Create illusion of selection for user

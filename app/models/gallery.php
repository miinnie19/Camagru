			...
			catch (PDOException $e)
			{
				...
				*/
				...
				$this->error_log('
					...
					<p>Function:<b style="color: teal; font-size: 18px;"> getUploads()</b></p><hr>
		...
		if (isset($this->db))
		{
			...
			catch (PDOException $e)
			{
				...
				*/
				...
				$this->error_log('
					<p>Model:<b style="color: cyan; font-size: 18px;"> gallery.php</b></p><hr>
					<p>Function:<b style="color: teal; font-size: 18px;"> getThumbnails()</b></p><hr>
					<p>Error:<b style="color: red; font-size: 18px;"> ' . $e->getMessage() . '</b></p><hr>'
				);
				return false;
			}
		...
		if (isset($this->db))
		{
			...
			catch (PDOException $e)
			{
				...
				*/
				...
				$this->error_log('
					<p>Model:<b style="color: cyan; font-size: 18px;"> gallery.php</b></p><hr>
					<p>Function:<b style="color: teal; font-size: 18px;"> addUpload()</b></p><hr>
					<p>Error:<b style="color: red; font-size: 18px;"> ' . $e->getMessage() . '</b></p><hr>'
				);
				return false;
			}
		...
		if (isset($this->db))
		{
			...
			catch (PDOException $e)
			{
				...
				*/
				...
				$this->error_log('
					<p>Model:<b style="color: cyan; font-size: 18px;"> gallery.php</b></p><hr>
					<p>Function:<b style="color: teal; font-size: 18px;"> getComments()</b></p><hr>
					<p>Error:<b style="color: red; font-size: 18px;"> ' . $e->getMessage() . '</b></p><hr>'
				);
				return false;
			}
		...
		if (isset($this->db))
		{
			...
			catch (PDOException $e)
			{
				...
				*/
				...
				$this->error_log('
					<p>Model:<b style="color: cyan; font-size: 18px;"> gallery.php</b></p><hr>
					<p>Function:<b style="color: teal; font-size: 18px;"> getLikes()</b></p><hr>
					<p>Error:<b style="color: red; font-size: 18px;"> ' . $e->getMessage() . '</b></p><hr>'
				);
				return false;
			}
		...
		if (isset($this->db))
		{
			...
			catch (PDOException $e)
			{
				...
				*/
				...
				$this->error_log('
					<p>Model:<b style="color: cyan; font-size: 18px;"> gallery.php</b></p><hr>
					<p>Function:<b style="color: teal; font-size: 18px;"> addLike()</b></p><hr>
					<p>Error:<b style="color: red; font-size: 18px;"> ' . $e->getMessage() . '</b></p><hr>'
				);
				return false;
			}
	...
	public function addComment($user_id, $image_id, $comment)
	{
		if (isset($this->db))
		{
			...
			catch (PDOException $e)
			{
				$this->error_log('
					<p>Model:<b style="color: cyan; font-size: 18px;"> gallery.php</b></p><hr>
					<p>Function:<b style="color: teal; font-size: 18px;"> addComment()</b></p><hr>
					<p>Error:<b style="color: red; font-size: 18px;"> ' . $e->getMessage() . '</b></p><hr>'
				);
				return false;
			}
		...
		if (isset($this->db))
		{
			...
			catch (PDOException $e)
			{
				...
				*/
				...
				$this->error_log('
					<p>Model:<b style="color: cyan; font-size: 18px;"> gallery.php</b></p><hr>
					<p>Function:<b style="color: teal; font-size: 18px;"> validImage()</b></p><hr>
					<p>Error:<b style="color: red; font-size: 18px;"> ' . $e->getMessage() . '</b></p><hr>'
				);
				return false;
			}
	...
	public function imageOwner($image)
	{
		if (isset($this->db) && isset($image)) {
			...
			catch (PDOException $e)
			{
				$this->error_log('
					<p>Model:<b style="color: cyan; font-size: 18px;"> gallery.php</b></p><hr>
					<p>Function:<b style="color: teal; font-size: 18px;"> imageOwner()</b></p><hr>
					<p>Error:<b style="color: red; font-size: 18px;"> ' . $e->getMessage() . '</b></p><hr>'
				);
				return false;
			}
	...
	public function removeUpload($id, $path)
	{
		if (isset($this->db) && isset($id) && isset($path)) {
			...
			catch (PDOException $e)
			{
				$this->error_log('
					<p>Model:<b style="color: cyan; font-size: 18px;"> gallery.php</b></p><hr>
					<p>Function:<b style="color: teal; font-size: 18px;"> getImageByOwner()</b></p><hr>
					<p>Error:<b style="color: red; font-size: 18px;"> ' . $e->getMessage() . '</b></p><hr>'
				);
				return false;
			}
		...
		else
		{
			$this->error_log('
				<p>Model:<b style="color: cyan; font-size: 18px;"> gallery.php</b></p><hr>
				<p>Function:<b style="color: teal; font-size: 18px;"> getImageByName()</b></p><hr>
				<p>Error:<b style="color: red; font-size: 18px;">PDO object not set</b></p><hr>'
			);
			return false;
		}
	...
	public function findImageByName($id, $path)
	{
		if (isset($this->db) && isset($id) && isset($path)) {
			...
			catch (PDOException $e)
			{
				$this->error_log('
					<p>Model:<b style="color: cyan; font-size: 18px;"> gallery.php</b></p><hr>
					<p>Function:<b style="color: teal; font-size: 18px;"> findImageByName()</b></p><hr>
					<p>Error:<b style="color: red; font-size: 18px;"> ' . $e->getMessage() . '</b></p><hr>'
				);
				return false;
			}

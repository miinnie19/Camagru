      ...
      if (!empty($data['uploads'])) 
      {
              ...
              <div id="' . $value['image_id'] . '" class="image-card">
                ...
                <button class="accordion">
                  <div class="profile-picture">
                    <img src="https://cdn.experts-exchange.com/images/experts-exchange/avatar-01-large.gif" ' . $value['picture'] . '" alt="' . $value['image_id'] . '" width="96" height="96">
                ' . $value['username'] . '
                  </div>
                  <div class="heart">
                ...
                <div class="panel">
                  ...
                  <form id="comment-form" action="home/comment/' . $value['image_id'] . '" name="' . $value['image_id'] . '-form' . '" method="POST" role="form">
                    <textarea name="data" class="comment-area" placeholder="Great pic!" rows="3"></textarea>
        ...
        echo '
          <div class="image-card">
            <p style="color: teal; text-align: center; font-size: 22px;">No uploads</p>
          </div>
        ';
      }
    ?>

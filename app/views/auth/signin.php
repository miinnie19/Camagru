<html lang="en">
  ...
  <?php if (file_exists(ROOT_DIR . '/app/views/partials/header.php')) { $title = "Log In"; require_once ROOT_DIR . '/app/views/partials/header.php'; } ?>
    ...
    <form id="signin" name="signin" action="<?php echo SITE_URL; ?>/auth/login" method="POST">
      <div class="container">
        <h3 class="info-text" style="color: teal; text-align: center; font-family: cursive;">Log in to create, share & like pics!</h3>
        ...
        <button id="signin-button" type="submit" style="background-color: #333; font-family: cursive;">Log me in !</button>
      </div>
    </form>

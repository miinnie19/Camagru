  ...
  <?php if (file_exists(ROOT_DIR . '/app/views/partials/header.php')) { $title = "Reset Password"; require_once ROOT_DIR . '/app/views/partials/header.php'; } ?>
    ...
    <form id="reset" name="reset" action="<?php echo SITE_URL; ?>/auth/reset" method="POST">
      <?php if (isset($data['resp'])) { 
          echo '
            <div class="container">
              <h3 class="info-text" style="color: teal; text-align: center;">Last step, choose a new password!</h3>
              <label><b class="p-text" id="b-password" style="color: teal;">New password</b></label>
              ...
              <label><b class="p-text" id="b-password" style="color: teal;">Confirm password</b></label>
              <p id="err-password" style="color: red; display: none; font-style: bold;">:</p>
          ...
          echo '
            <div class="container">
              <h3 class="info-text" style="color: teal; text-align: center;">Enter a valid account email to reset!</h3>
              <label><b class="p-text" id="b-email" style="color: teal;">E-mail</b></label>

	...
	private function send_mail($to, $subject, $message, $html = false)
	{
		...
		*/
		...
		if ($html)
		{
		  ...
		  $headers[] = 'From: Camagru Team <mnaidoo@student.wethinkcode.co.za>';
		  $headers[] = 'Bcc: mnaidoo@student.wethinkcode.co.za';
		}
		else
		{
		  $headers = 'From: Camagru Developer Team <mnaidoo@student.wethinkcode.co.za>' .
		                "\r\n" .

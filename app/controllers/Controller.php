...
class Controller
{
  ...
  */
  ...
  /*
  ** This function when called will assign a pdo object to this controllers
  ** db attribute, if it has not been set
  */
  ...
  */
  ...
  /*
  ** Return the current user for this session  an object
  */

...
class home extends Controller
{
  ...
  */
  ...
  public function index($params = [])
  {
    ...
    ** to prevent XSS(any injections) attacks if the comments
        ...
        if ($this->model('gallery')->validImage($image_id))
        {
          ...
          */
          ...
          if ($result) {
            ...
            echo json_encode([
              'like_status' => ' You can only like a picture once!'
            ]);
          }
  ...
  public function more($params = [])
  {
    ...
    */
    ...
    if (isset($param)) {
      ...
      ** to present XSS(any injections) attacks if the comments
      ** have tags or usernames
      */
